...
function Dashboard() {
    ...
    const fetchTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[fetchTransactions]": async ()=>{
            setLoading(true);
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('*').order('created_at', {
                ascending: false
            });
    ...
    }["Dashboard.useCallback[fetchTransactions]"], []);
    ...
    const filteredTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[filteredTransactions]": ()=>{
            return transactions.filter({
                "Dashboard.useMemo[filteredTransactions]": (t)=>{
    ...
    const { income, expenses, balance } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo": ()=>{
            const inc = filteredTransactions.filter({
                "Dashboard.useMemo.inc": (t)=>t.type === 'income'
            }["Dashboard.useMemo.inc"]).reduce({
                "Dashboard.useMemo.inc": (acc, curr)=>acc + Number(curr.amount)
            }["Dashboard.useMemo.inc"], 0);
            const exp = filteredTransactions.filter({
                "Dashboard.useMemo.exp": (t)=>t.type === 'expense'
            }["Dashboard.useMemo.exp"]).reduce({
                "Dashboard.useMemo.exp": (acc, curr)=>acc + Number(curr.amount)
            }["Dashboard.useMemo.exp"], 0);
            return {
                income: inc,
                expenses: exp,
                balance: inc - exp
    ...
    const categoryData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[categoryData]": ()=>{
            const breakdown = filteredTransactions.filter({
                "Dashboard.useMemo[categoryData].breakdown": (t)=>t.type === 'expense'
            }["Dashboard.useMemo[categoryData].breakdown"]).reduce({
                "Dashboard.useMemo[categoryData].breakdown": (acc, curr)=>{
                    acc[curr.category] = (acc[curr.category] || 0) + Number(curr.amount);
                    return acc;
                }
            }["Dashboard.useMemo[categoryData].breakdown"], {});
            return Object.keys(breakdown).map({
                "Dashboard.useMemo[categoryData]": (name)=>({
                        name,
    ...
    const handleSubmit = async (e)=>{
        ...
        if (editingId) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').update(payload).eq('id', editingId);
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').insert([
                payload
            ]);
            if (error) alert(error.message);
            else {
    ...
    const deleteTransaction = async (id)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').delete().eq('id', id);
        if (error) alert(error.message);
                                    ...
                                    children: [
                                        ...
                                        categoryData.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "space-y-4",
                                                    children: categoryData.map((cat, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            lineNumber: 402,
                                            columnNumber: 19
                                        }, this) : filteredTransactions.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Dashboard, "IOVKWontmmmQSFDJxsH0CqZ10zs=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=src_599632b5._.js.map